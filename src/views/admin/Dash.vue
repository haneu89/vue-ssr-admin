  ...
  <div :class="['wrapper', classes]">
    <header class="main-header">
      <a href="/" class="logo">
        ...
        <span class="logo-mini"><img src="/public/img/copilot-logo-white.svg" alt="Logo" class="img-responsive center-block"></span>
        <!-- logo for regular state and mobile devices -->
        <div class="logo-lg">
          <img src="/public/img/copilot-logo-white.svg" alt="Logo" class="img-responsive">
          <span>makeit</span>
        </div>
      </a>
      <!-- Header Navbar -->
